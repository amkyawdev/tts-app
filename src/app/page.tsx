  ...
  return (
    <main className="min-h-screen p-6">
      ...
      <section className="glass-card p-8 mb-8 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-gray-500/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
        
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-gray-600 to-gray-900 flex items-center justify-center animate-pulse-glow">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link 
              href="/tts"
              className="glass-button flex items-center gap-2 bg-gray-900/30 hover:bg-gray-900/50"
            >
              Get Started
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {features.map((feature, index) => {
          ...
          return (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-gray-600/30 to-gray-900/30 flex items-center justify-center mb-4">
